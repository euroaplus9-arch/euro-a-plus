const products = {
    ...
    4: { nameKey: 'cement1_name', specsKey: 'cement1_specs', descKey: 'cement1_desc', img: 'images/cement1.jpg', price: 38, oldPrice: 45, priceFormatted: '38 ₾', oldPriceFormatted: '45 ₾' },
    5: { nameKey: 'cement2_name', specsKey: 'cement2_specs', descKey: 'cement2_desc', img: 'images/cement2.jpg', price: 32, oldPrice: 38, priceFormatted: '32 ₾', oldPriceFormatted: '38 ₾' }
};
...
const translations = {
    ka: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"წონა: 50 კგ • სიმტკიცე: M500 • ტიპი: უნივერსალური • წარმოება: ირანი", cement1_desc:"მაღალი ხარისხის უნივერსალური ცემენტი WASP S-9. იდეალურია ყველა სახის სამშენებლო სამუშაოებისთვის.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"წონა: 40 კგ • სიმტკიცე: M400 • ტიპი: სტანდარტული • წარმოება: ირანი", cement2_desc:"სტანდარტული ცემენტი WASP S-7. შესანიშნავი არჩევანი საშუალო დატვირთვის სამშენებლო სამუშაოებისთვის.",
        ...
        footer_desc:"ფილები და ცემენტები საქართველოში", footer_address:"თბილისი, ნადირა ხოშარაულის ქ.",
    ...
    ru: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"Вес: 50 кг • Прочность: M500 • Тип: универсальный • Производство: Иран", cement1_desc:"Высококачественный универсальный цемент WASP S-9. Идеален для всех видов строительных работ.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"Вес: 40 кг • Прочность: M400 • Тип: стандартный • Производство: Иран", cement2_desc:"Стандартный цемент WASP S-7. Отличный выбор для строительных работ со средней нагрузкой.",
        ...
        footer_desc:"Плитка и цементы в Грузии", footer_address:"Тбилиси, ул. Надира Хошараули",
    ...
    en: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"Weight: 50 kg • Strength: M500 • Type: universal • Made in Iran", cement1_desc:"High-quality universal WASP S-9 cement. Ideal for all types of construction works.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"Weight: 40 kg • Strength: M400 • Type: standard • Made in Iran", cement2_desc:"Standard WASP S-7 cement. Great choice for medium-load construction works.",
        ...
        footer_desc:"Tiles & Cements in Georgia", footer_address:"Tbilisi, Nadira Khosharauli St.",
    ...
    tr: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"Ağırlık: 50 kg • Dayanım: M500 • Tip: üniversal • Üretim: İran", cement1_desc:"Yüksek kaliteli üniversal WASP S-9 çimento. Her türlü inşaat işi için ideal.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"Ağırlık: 40 kg • Dayanım: M400 • Tip: standart • Üretim: İran", cement2_desc:"Standart WASP S-7 çimento. Orta yük için inşaat işleri için harika bir seçim.",
        ...
        footer_desc:"Gürcistan'da fayans ve çimentolar", footer_address:"Tiflis, Nadira Hoşarauli Caddesi",
    ...
    az: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"Çəki: 50 kq • Möhkəmlik: M500 • Tip: universal • İstehsal: İran", cement1_desc:"Yüksək keyfiyyətli universal WASP S-9 sementi. Bütün növ tikinti işləri üçün ideal.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"Çəki: 40 kq • Möhkəmlik: M400 • Tip: standart • İstehsal: İran", cement2_desc:"Standart WASP S-7 sementi. Orta yüklü tikinti işləri üçün əla seçim.",
        ...
        footer_desc:"Gürcüstanda kafel və sementlər", footer_address:"Tbilisi, Nadira Xoşarauli küç.",
    ...
    fa: {
        ...
        cement1_name:"WASP S-9 Universal", cement1_specs:"وزن: ۵۰ کیلوگرم • مقاومت: M500 • نوع: جهانی • ساخت: ایران", cement1_desc:"سیمان جهانی با کیفیت بالا WASP S-9. ایده‌آل برای تمام انواع کارهای ساختمانی.",
        cement2_name:"WASP S-7 Standard", cement2_specs:"وزن: ۴۰ کیلوگرم • مقاومت: M400 • نوع: استاندارد • ساخت: ایران", cement2_desc:"سیمان استاندارد WASP S-7. انتخاب عالی برای کارهای ساختمانی با بار متوسط.",
        ...
        footer_desc:"کاشی و سیمان در گرجستان", footer_address:"تفلیس، خیابان نادیرا خوشاراولی",
